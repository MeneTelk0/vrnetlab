...
class VMX_vcp(vrnetlab.VM):
    ...
    def bootstrap_config(self):
        ...
        self.wait_write("set interfaces ge-0/0/0 unit 0 family inet address 10.10.11.1/24")
        self.wait_write("set interfaces ge-0/0/0 unit 0 family iso")
        self.wait_write("set interfaces ge-0/0/0 unit 0 family mpls")
        self.wait_write("set interfaces ge-0/0/1 unit 0 family inet address 10.10.12.2/24")
        self.wait_write("set interfaces ge-0/0/1 unit 0 family iso")
        self.wait_write("set interfaces ge-0/0/1 unit 0 family mpls")
        self.wait_write("set interfaces ge-0/0/2 encapsulation ethernet-ccc")
        self.wait_write("set interfaces ge-0/0/2 unit 0 family ccc")
        self.wait_write("set interfaces lo0 unit 0 family inet address 2.2.2.2/32")
        self.wait_write("set interfaces lo0 unit 0 family iso address 10.0000.0000.0002.00;")
        self.wait_write("set interfaces lo0 unit 0 family mpls")

        self.wait_write("set routing-options router-id 2.2.2.2")
        self.wait_write("set routing-options route-distinguisher-id 2.2.2.2;")
        self.wait_write("set routing-options autonomous-system 64500")

        self.wait_write("set protocols mpls interface fxp0.0 disable")
        self.wait_write("set protocols mpls interface all")
        self.wait_write("set protocols bgp group Internal type internal")
        self.wait_write("set protocols bgp group Internal local-address 2.2.2.2")
        self.wait_write("set protocols bgp group Internal family inet unicast")
        self.wait_write("set protocols bgp group Internal family inet-vpn unicast")
        self.wait_write("set protocols bgp group Internal neighbor 3.3.3.3")
        self.wait_write("set protocols bgp group Internal neighbor 1.1.1.1")
        self.wait_write("set protocols isis interface ge-0/0/0.0")
        self.wait_write("set protocols isis interface ge-0/0/1.0")
        self.wait_write("set protocols isis interface lo0.0 passive")
        self.wait_write("set protocols ldp transport-address router-id")
        self.wait_write("set protocols ldp interface ge-0/0/0.0")
        self.wait_write("set protocols ldp interface ge-0/0/1.0")
        self.wait_write("set protocols ldp interface lo0.0")
        self.wait_write("set protocols l2circuit neighbor 1.1.1.1 interface ge-0/0/2.0 virtual-circuit-id 11")

        self.wait_write("set policy-options policy-statement bgp-to-vrf term 2 then reject")
        self.wait_write("set policy-options policy-statement bgp-to-vrf term 1 from protocol static")
        self.wait_write("set policy-options policy-statement bgp-to-vrf term 1 from protocol bgp")
        self.wait_write("set policy-options policy-statement bgp-to-vrf term 1 then accept")
