...
class CSR_vm(vrnetlab.VM):
    ...
    def bootstrap_config(self):
        ...
        self.wait_write("ip vrf l3vpn")
        self.wait_write("rd 64500:100")
        self.wait_write("route-target export 64500:100")
        self.wait_write("route-target import 64500:100")
        ...
        self.wait_write("ip address 1.1.1.1 255.255.255.255")
        self.wait_write("ip router isis 1")
        self.wait_write("no shut")
        self.wait_write("exit")

        self.wait_write("interface GigabitEthernet2")
        self.wait_write("ip address 10.10.12.1 255.255.255.0")
        self.wait_write("ip router isis 1")
        self.wait_write("mpls ip")
        self.wait_write("no shut")
        self.wait_write("exit")

        self.wait_write("interface GigabitEthernet3")
        self.wait_write("ip address 10.10.10.1 255.255.255.0")
        self.wait_write("ip router isis 1")
        self.wait_write("mpls ip")
        self.wait_write("no shut")
        self.wait_write("exit")

        self.wait_write("interface GigabitEthernet4")
        self.wait_write("ip address 10.0.0.15 255.255.255.0")
        self.wait_write("xconnect 2.2.2.2 11 encapsulation mpls")
        self.wait_write("no shut")
        self.wait_write("exit")

        self.wait_write("interface GigabitEthernet5")
        self.wait_write("ip address 192.168.0.1 255.255.255.0")
        self.wait_write("ip vrf forwarding l3vpn")
        self.wait_write("no shut")
        self.wait_write("exit")
        ...
        self.wait_write("router isis 1")
        self.wait_write("net 10.0000.0000.0001.00")
        self.wait_write("exit")

        self.wait_write("router bgp 64500")
        self.wait_write("bgp log-neighbor-changes")
        self.wait_write("neighbor 2.2.2.2 remote-as 64500")
        self.wait_write("neighbor 2.2.2.2 update-source Loopback0")
        self.wait_write("neighbor 3.3.3.3 remote-as 64500")
        self.wait_write("neighbor 3.3.3.3 update-source Loopback0")
        self.wait_write("address-family vpnv4")
        self.wait_write("neighbor 2.2.2.2 activate")
        self.wait_write("neighbor 2.2.2.2 send-community both")
        self.wait_write("neighbor 3.3.3.3 activate")
        self.wait_write("neighbor 3.3.3.3 send-community both")
        self.wait_write("exit")
        self.wait_write("address-family ipv4 vrf l3vpn")
        self.wait_write("redistribute connected")
        self.wait_write("neighbor 192.168.0.2 remote-as 64510")
        self.wait_write("neighbor 192.168.0.2 activate")
        self.wait_write("exit")
        self.wait_write("exit")

        self.wait_write("mpls ldp router-id Loopback0 force")
