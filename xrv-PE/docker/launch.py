...
class XRV_vm(vrnetlab.VM):
    ...
    def bootstrap_config(self):
        ...
        self.wait_write("vrf l3vpn")
        self.wait_write("address-family ipv4 unicast")
        self.wait_write("import route-target")
        self.wait_write("64500:100")
        self.wait_write("exit")
        self.wait_write("export route-target")
        self.wait_write("64500:100")
        self.wait_write("exit")
        self.wait_write("exit")
        self.wait_write("exit")
        self.wait_write("interface Loopback0")
        self.wait_write("ipv4 address 3.3.3.3 255.255.255.255")
        self.wait_write("no shutdown ")
        self.wait_write("exit")
        self.wait_write("interface MgmtEth0/0/CPU0/0")
        self.wait_write("ipv4 address 10.0.0.15 255.255.255.0")
        self.wait_write("no shutdown")
        self.wait_write("exit")
        self.wait_write("interface GigabitEthernet0/0/0/0")
        self.wait_write("ipv4 address 10.10.11.2 255.255.255.0")
        self.wait_write("no shutdown ")
        self.wait_write("exit")
        self.wait_write("interface GigabitEthernet0/0/0/1")
        self.wait_write("ipv4 address 10.10.10.2 255.255.255.0")
        self.wait_write("no shutdown ")
        self.wait_write("exit")
        self.wait_write("interface GigabitEthernet0/0/0/2.1502 l2transport")
        self.wait_write("encapsulation dot1q 1502")
        self.wait_write("rewrite ingress tag pop 1 symmetric")
        self.wait_write("mtu 1518")
        self.wait_write("no shutdown ")
        self.wait_write("exit")
        self.wait_write("interface GigabitEthernet0/0/0/3")
        self.wait_write("vrf l3vpn")
        self.wait_write("ipv4 address 192.168.1.1 255.255.255.0")
        self.wait_write("no shutdown ")
        self.wait_write("exit")
        self.wait_write("router static")
        self.wait_write("vrf l3vpn")
        self.wait_write("address-family ipv4 unicast")
        self.wait_write("0.0.0.0/0 192.168.0.1")
        self.wait_write("exit")
        self.wait_write("exit")
        self.wait_write("exit")
        self.wait_write("router isis LAB")
        self.wait_write("net 10.0000.0000.0003.00")
        self.wait_write("interface Loopback0")
        self.wait_write("address-family ipv4 unicast")
        self.wait_write("exit")
        self.wait_write("interface GigabitEthernet0/0/0/0")
        self.wait_write("address-family ipv4 unicast")
        self.wait_write("mpls ldp sync")
        self.wait_write("exit")
        self.wait_write("interface GigabitEthernet0/0/0/1")
        self.wait_write("address-family ipv4 unicast")
        self.wait_write(" mpls ldp sync")
        ...
        self.wait_write("address-family ipv4 unicast")
        self.wait_write("exit")
        self.wait_write("address-family vpnv4 unicast")
        self.wait_write("exit")
        self.wait_write("neighbor 1.1.1.1")
        self.wait_write("remote-as 64500")
        self.wait_write("update-source Loopback0")
        self.wait_write("address-family ipv4 unicast")
        self.wait_write("exit")
        self.wait_write("address-family vpnv4 unicast")
        self.wait_write("exit")
        self.wait_write("exit")
        self.wait_write("neighbor 2.2.2.2")
        self.wait_write("remote-as 64500")
        self.wait_write("update-source Loopback0")
        self.wait_write("address-family ipv4 unicast")
        self.wait_write("exit")
        ...
        self.wait_write("exit")
        self.wait_write("vrf l3vpn")
        self.wait_write("rd 64500:200")
        self.wait_write("address-family ipv4 unicast")
        self.wait_write("redistribute connected")
        self.wait_write("exit")
        self.wait_write("exit")
        self.wait_write("exit")
        self.wait_write("mpls oam")
        self.wait_write("mpls ldp")
        self.wait_write("router-id 3.3.3.3")
